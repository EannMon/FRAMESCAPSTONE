# Charlie Sample Test - Student Report Seed Pack

Purpose: seed reproducible student-report attendance data for Charlie Sample Test (`users.id = 149`) using only the `attendance_logs` table.

Student reference:
- Name: Charlie Sample Test
- User ID: 149
...
- `002_seed_charlie_it4.sql`   : Subject `IT4` (`classes.id = 18`)
- `003_seed_charlie_it36.sql`  : Subject `IT36` (`classes.id = 19`)
- `004_seed_charlie_it45.sql`  : Subject `IT45` (`classes.id IN (20,21)`)
- `005_seed_charlie_cc3.sql`   : Subject `CC3` (`classes.id IN (22,23)`)
- `900_monitor_charlie_report_seed_status.sql` : Read-only monitoring queries (coverage, totals, seeded rows)
...
Example run (psql):
```sql
\i reporttesting/studentreports/charlie_sample_test/001_seed_charlie_it3.sql
\i reporttesting/studentreports/charlie_sample_test/002_seed_charlie_it4.sql
\i reporttesting/studentreports/charlie_sample_test/003_seed_charlie_it36.sql
\i reporttesting/studentreports/charlie_sample_test/004_seed_charlie_it45.sql
\i reporttesting/studentreports/charlie_sample_test/005_seed_charlie_cc3.sql
```
