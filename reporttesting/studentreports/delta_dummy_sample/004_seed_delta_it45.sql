-- Delta Dummy Sample seed: IT45 (Subject ID 13, Class IDs 20 and 21)
-- Seeds only attendance_logs table.
--
-- Existing data note (snapshot: databasedatafornow0329.txt):
--   - For Delta (user_id=155), class_ids=20/21 currently have 0 logs.
--   - Delta has existing logs in class_id=24 (ENTRY=1, BREAK_OUT=1), not part of IT45.
--
...
-- WHERE user_id=155 AND class_id IN (20,21)
-- GROUP BY 1,2,3,4
-- ORDER BY 1,2,3,4;
--
