-- Delta Dummy Sample seed: IT4 (Subject ID 11, Class ID 18)
-- Seeds only attendance_logs table.
--
-- Existing data note (snapshot: databasedatafornow0329.txt):
--   - For Delta (user_id=155), class_id=18 currently has 0 logs.
--   - Delta has existing logs in class_id=24 (ENTRY=1, BREAK_OUT=1), not part of IT4.
--
...
-- WHERE user_id=155 AND class_id=18
-- GROUP BY 1,2,3
-- ORDER BY 1,2,3;
--
