...
This chapter introduces the research problem, situates the study within its institutional and technological context, outlines the system objectives, and explains the significance of the work. Together, these elements establish the foundation for the development and evaluation of FRAMES: A Web-Based, Gesture-Gated Facial Recognition Attendance System Using Raspberry Pi.

---

### Introduction

Attendance monitoring is a critical institutional process in higher education. Accurate attendance records inform decisions about student engagement, faculty compliance, classroom utilization, and departmental oversight. When that data is unreliable, institutions lose visibility into whether scheduled classes were actually conducted, who was physically present, and whether rooms were being used as intended.
...
**For faculty members**, the system eliminates the need for manual roll calls and produces class-level attendance reports automatically. Faculty can view per-session attendance summaries, identify students with attendance concerns, and export records for grading or administrative documentation.
